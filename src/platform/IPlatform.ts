/**
 * IPlatform — platform-agnostic interface for all backend operations.
 * Implemented by ElectronPlatform (wraps window.electronAPI) and
 * WebPlatform (calls the Express web server via fetch).
 */
import type {
